...
<head>
    ...
    <title>IBM DrAutomation Service</title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css" crossorigin="anonymous">
</head>
<body>
<div class="container">
    <div class="page-header">
        <h1>IBM DrAutomation Service Java SDK Documentation</h1>
    </div>

    <p><a href="https://cloud.ibm.com/docs/dr-automation-powervs">DrAutomation Service Info</a>
        | <a href="https://github.com/IBM/dra-java-sdk">GitHub</a>
    </p>
