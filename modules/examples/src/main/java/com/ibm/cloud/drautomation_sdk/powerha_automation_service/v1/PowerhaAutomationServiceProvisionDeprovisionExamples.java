...
public class PowerhaAutomationServiceProvisionDeprovisionExamples {
  private static final Logger logger = LoggerFactory.getLogger(PowerhaAutomationServiceProvisionDeprovisionExamples.class);
  private static final ObjectMapper mapper = new ObjectMapper().enable(SerializationFeature.INDENT_OUTPUT);
  protected PowerhaAutomationServiceProvisionDeprovisionExamples() { }
  ...
  private static final String PLAN_NAME = "powerha-aix-powervs"; // Mention your plan name for your service to create the provision.
  private static final String INSTANCE_NAME = "javaphasdktest";
  ...
  //  */
  // private PowerhaAutomationServiceProvisionDeprovisionExamples() {
