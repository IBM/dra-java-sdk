...
// >>> Replace "drautomation_sdk" with the correct value for your project
package com.ibm.cloud.drautomation_sdk.common;
...
public class SdkCommon {
    ...
    // >>> Replace "drautomation_sdk" with the parent project's artifactId (e.g. platform-services)
    private static String parentArtifactId = "drautomation_sdk";
     ...
     * my-java-sdk/0.0.2 (lang=java; java.vendor=AdoptOpenJDK; java.version=1.8.0_232; os.arch=x86_64; os.name=Linux; os.version=5.1)
