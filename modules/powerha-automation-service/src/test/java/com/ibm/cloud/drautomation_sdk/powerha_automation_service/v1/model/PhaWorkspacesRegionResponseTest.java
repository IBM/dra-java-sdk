...
/**
 * Unit test class for the PhaWorkspacesRegionResponse model.
 */
public class PhaWorkspacesRegionResponseTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testPhaWorkspacesRegionResponse() throws Throwable {
    PhaWorkspacesRegionResponse phaWorkspacesRegionResponseModel = new PhaWorkspacesRegionResponse();
    assertNull(phaWorkspacesRegionResponseModel.getWorkspaces());
  }
}