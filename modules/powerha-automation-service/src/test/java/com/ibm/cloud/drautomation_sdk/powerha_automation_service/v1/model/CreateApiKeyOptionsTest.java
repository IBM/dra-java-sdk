...
public class CreateApiKeyOptionsTest {
  ...
  public void testCreateApiKeyOptions() throws Throwable {
    CreateApiKeyOptions createApiKeyOptionsModel = new CreateApiKeyOptions.Builder()
      ...
      .build();
    assertEquals(createApiKeyOptionsModel.phaInstanceId(), "8eefautr-4c02-0009-0086-8bd4d8cf61b6");
    assertEquals(createApiKeyOptionsModel.apiKey(), "adfadfdsafsdfdsf");
    assertEquals(createApiKeyOptionsModel.acceptLanguage(), "en-US");
  }
