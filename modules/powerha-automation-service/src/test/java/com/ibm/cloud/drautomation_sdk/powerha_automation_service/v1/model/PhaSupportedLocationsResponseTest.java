...
/**
 * Unit test class for the PhaSupportedLocationsResponse model.
 */
public class PhaSupportedLocationsResponseTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testPhaSupportedLocationsResponse() throws Throwable {
    PhaSupportedLocationsResponse phaSupportedLocationsResponseModel = new PhaSupportedLocationsResponse();
    assertNull(phaSupportedLocationsResponseModel.getLocations());
  }
}