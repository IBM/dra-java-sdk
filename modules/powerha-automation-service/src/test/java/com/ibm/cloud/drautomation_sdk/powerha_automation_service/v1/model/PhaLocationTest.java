...
/**
 * Unit test class for the PhaLocation model.
 */
public class PhaLocationTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testPhaLocation() throws Throwable {
    PhaLocation phaLocationModel = new PhaLocation();
    assertNull(phaLocationModel.getId());
    assertNull(phaLocationModel.getName());
  }
}