...
/**
 * Unit test class for the ApiKeyResponse model.
 */
public class ApiKeyResponseTest {
  ...
  @Test
  public void testApiKeyResponse() throws Throwable {
    ApiKeyResponse apiKeyResponseModel = new ApiKeyResponse();
    assertNull(apiKeyResponseModel.getStatus());
    assertNull(apiKeyResponseModel.getId());
  }
}