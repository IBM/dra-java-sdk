...
/**
 * Unit test class for the DetailsDr model.
 */
public class DetailsDrTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDetailsDr() throws Throwable {
    DetailsDr detailsDrModel = new DetailsDr();
    assertNull(detailsDrModel.getCrn());
  }
}