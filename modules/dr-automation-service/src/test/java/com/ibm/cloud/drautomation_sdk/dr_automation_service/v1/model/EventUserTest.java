...
/**
 * Unit test class for the EventUser model.
 */
public class EventUserTest {
  ...
  @Test
  public void testEventUser() throws Throwable {
    EventUser eventUserModel = new EventUser();
    assertNull(eventUserModel.getEmail());
    assertNull(eventUserModel.getName());
    assertNull(eventUserModel.getUserId());
  }
}