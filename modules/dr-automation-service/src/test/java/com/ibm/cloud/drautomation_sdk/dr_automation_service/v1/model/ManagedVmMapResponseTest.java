...
/**
 * Unit test class for the ManagedVmMapResponse model.
 */
public class ManagedVmMapResponseTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testManagedVmMapResponse() throws Throwable {
    ManagedVmMapResponse managedVmMapResponseModel = new ManagedVmMapResponse();
    assertNull(managedVmMapResponseModel.getManagedVmList());
  }
}