...
/**
 * Unit test class for the GetDrManagedVmOptions model.
 */
public class GetDrManagedVmOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetDrManagedVmOptions() throws Throwable {
    GetDrManagedVmOptions getDrManagedVmOptionsModel = new GetDrManagedVmOptions.Builder()
      ...
      .build();
    assertEquals(getDrManagedVmOptionsModel.instanceId(), "123456d3-1122-3344-b67d-4389b44b7bf9");
    assertEquals(getDrManagedVmOptionsModel.acceptLanguage(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testGetDrManagedVmOptionsError() throws Throwable {
    new GetDrManagedVmOptions.Builder().build();
  }
