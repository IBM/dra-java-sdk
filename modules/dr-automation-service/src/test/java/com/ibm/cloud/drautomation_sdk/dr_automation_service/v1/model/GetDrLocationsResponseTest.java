...
/**
 * Unit test class for the GetDrLocationsResponse model.
 */
public class GetDrLocationsResponseTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetDrLocationsResponse() throws Throwable {
    GetDrLocationsResponse getDrLocationsResponseModel = new GetDrLocationsResponse();
    assertNull(getDrLocationsResponseModel.getDrLocations());
  }
}