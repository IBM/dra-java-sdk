...
public class UpdateApikeyOptionsTest {
  ...
  public void testUpdateApikeyOptions() throws Throwable {
    UpdateApikeyOptions updateApikeyOptionsModel = new UpdateApikeyOptions.Builder()
      ...
      .build();
    assertEquals(updateApikeyOptionsModel.instanceId(), "123456d3-1122-3344-b67d-4389b44b7bf9");
    assertEquals(updateApikeyOptionsModel.apiKey(), "adfadfdsafsdfdsf");
    assertEquals(updateApikeyOptionsModel.acceptLanguage(), "testString");
  }
