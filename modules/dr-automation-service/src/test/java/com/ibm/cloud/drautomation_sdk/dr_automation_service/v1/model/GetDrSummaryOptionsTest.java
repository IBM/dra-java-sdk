...
/**
 * Unit test class for the GetDrSummaryOptions model.
 */
public class GetDrSummaryOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetDrSummaryOptions() throws Throwable {
    GetDrSummaryOptions getDrSummaryOptionsModel = new GetDrSummaryOptions.Builder()
      ...
      .build();
    assertEquals(getDrSummaryOptionsModel.instanceId(), "123456d3-1122-3344-b67d-4389b44b7bf9");
    assertEquals(getDrSummaryOptionsModel.acceptLanguage(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testGetDrSummaryOptionsError() throws Throwable {
    new GetDrSummaryOptions.Builder().build();
  }
