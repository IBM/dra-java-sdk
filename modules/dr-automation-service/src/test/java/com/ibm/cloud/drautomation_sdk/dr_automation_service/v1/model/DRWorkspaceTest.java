...
/**
 * Unit test class for the DRWorkspace model.
 */
public class DRWorkspaceTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDRWorkspace() throws Throwable {
    DRWorkspace drWorkspaceModel = new DRWorkspace();
    assertNull(drWorkspaceModel.isXDefault());
    assertNull(drWorkspaceModel.getDetails());
    assertNull(drWorkspaceModel.getId());
    assertNull(drWorkspaceModel.getLocation());
    assertNull(drWorkspaceModel.getName());
    assertNull(drWorkspaceModel.getStatus());
  }
}