...
/**
 * Unit test class for the ServiceInstanceStatus model.
 */
public class ServiceInstanceStatusTest {
  ...
  @Test
  public void testServiceInstanceStatus() throws Throwable {
    ServiceInstanceStatus serviceInstanceStatusModel = new ServiceInstanceStatus();
    assertNull(serviceInstanceStatusModel.getCrn());
    assertNull(serviceInstanceStatusModel.getDeploymentName());
    assertNull(serviceInstanceStatusModel.getLastUpdatedOrchestratorDeploymentTime());
